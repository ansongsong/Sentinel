...
public class FlowRuleApolloPublisher implements DynamicRulePublisher<List<FlowRuleEntity>> {
    ...
    public void publish(String app, List<FlowRuleEntity> rules) throws Exception {
        ...
        apolloOpenApiClient.createOrUpdateItem(appId, "DEV", "default", ApolloConfig.namespace, openItemDTO);
        ...
        apolloOpenApiClient.publishNamespace(appId, "DEV", "default", ApolloConfig.namespace, namespaceReleaseDTO);
    }
}
